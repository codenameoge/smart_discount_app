...
function TodaysDeals() {
    const allDeals = [
        { id: 1, image: 'src/assets/pulsetracker.png', tag: 'Trending', subtitle: '20% Off' },
        { id: 2, image: 'src/assets/schoolbag.png', tag: 'Hot Deals', subtitle: '25% Off' },
        { id: 3, image: 'src/assets/mouse.png', tag: 'Trending', subtitle: '30% Off' },
        { id: 4, image: 'src/assets/shoe.png', tag: 'Hot Deals', subtitle: '35% Off' },
        { id: 5, image: 'src/assets/sofa.png', tag: 'Trending', subtitle: '40% Off' },
        { id: 6, image: 'src/assets/phone.png', tag: 'Hot Deals', subtitle: '50% Off' }
    ];
