...
//             <button
//               className="flex items-center justify-center w-64 px-4 py-2 mt-6 border rounded-lg bg-orange-500 text-white hover:bg-orange-900"
...
//             onClick={() => navigate('/discount/SAVE25NOW')}
//           >
//             SAVE25NOW
//           </button>
...
//           <button
//             className="flex items-center justify-center gap-2 w-full p-2 border rounded-lg bg-orange-500 text-white hover:bg-orange-900 mb-4"
//             onClick={() => navigate('/discount/SPRING15')}
//           >
//             SPRING15
//           </button>
//         </div>
...
//         <button
//           className="flex items-center justify-center gap-2 w-full p-2 border rounded-lg bg-orange-500 text-white hover:bg-orange-900 mb-4"
//           onClick={() => navigate('/confirm-discount')}
//         >
//           Confirm Discount
//         </button>
//       </div>
